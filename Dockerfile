...
RUN apt-get install -yqq --no-install-recommends asciidoc && git clone https://gitlab.com/git-latexdiff/git-latexdiff.git && cd git-latexdiff && make install && cd .. && rm -rf git-latexdiff

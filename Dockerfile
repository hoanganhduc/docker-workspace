...
RUN wget https://hoanganhduc.github.io/archlinux/x86_64/perl-latexml-0.8.4-2-any.pkg.tar.zst && pacman -U --needed --noconfirm perl-latexml-0.8.4-2-any.pkg.tar.zst && rm -rf perl-latexml-0.8.4-2-any.pkg.tar.zst
